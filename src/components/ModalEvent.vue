<template>
    <Transition name="modal-animation">
        <div v-if="modalEventActive" class="mainModal">
            <div @click="close" class="modalOverlay" v-on:click="TraceEvent('Model-Event-Close-', $store.state.id)"></div>
            <div class="modalContent iris" :class="randomNumber">
                <div @click="close" class="closeButton" v-on:click="TraceEvent('Model-Event-Close-', $store.state.id)">
        ...
        TraceEvent(description, user_id) {
            ...
            if (description && user_id) {
                UserService.getEventLogTraceContent(description, user_id).then((response) => {
                    ...
                    console.log('getModelEventLogTraceContent', error)
                })
            }
        },
    },
