<template>
  <Transition name="modal-animation">
      <div v-if="modalEdith" class="mainModalEdit">
          <div @click="close" class="modalOverlayEdit" v-on:click="TraceEvent('Model-Close-', $store.state.id)"></div>
          <div class="modalContentEdit iris" :class="randomNumber">
